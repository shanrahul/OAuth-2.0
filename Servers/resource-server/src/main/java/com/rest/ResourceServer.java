...
public class ResourceServer extends ResourceServerConfigurerAdapter{
    ...
    private String message = "Welcome To App";
    ...
    @PreAuthorize("#oauth2.hasScope('user_friend_write')")
...
//import org.springframework.web.bind.annotation.RequestParam;
    ...
    */
    ...
    @PreAuthorize("#oauth2.hasScope('user_friend_update')")
    ...
    @PreAuthorize("#oauth2.hasScope('user_friend_delete')")
